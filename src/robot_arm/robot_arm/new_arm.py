...
# Bus 1 (pins 28,27) is board SCL_1, SDA_1 in the jetson board definition file
# Bus 7 (pins 5, 3) is board SCL, SDA in the jetson definition file
# Default is to Bus 1; We are using Bus 0, so we need to construct the busio first ...
print("Initializing Servos")
i2c_bus7 = busio.I2C(board.SCL, board.SDA)
print("Initializing ServoKit")
kit = ServoKit(channels=16, i2c=i2c_bus7)
